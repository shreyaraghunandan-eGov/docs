...
* [Deploy DIGIT](deploy/README.md)
  ...
  * [DevOps](deploy/devops/README.md)
    * [CI/CD](deploy/devops/digit-ci-cd/README.md)
      * [Adding a new service to build pipeline](deploy/devops/digit-ci-cd/adding-a-new-service-to-build-pipeline.md)
    * [Monitoring & Alerts](deploy/devops/monitoring-and-alerts.md)
    * [Troubleshooting](deploy/devops/troubleshooting.md)
